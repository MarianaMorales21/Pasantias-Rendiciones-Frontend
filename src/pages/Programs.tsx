...
function ProgramForm({ formData, onChange, editMode = false, states, fieldErrors = {} }: ProgramFormProps) {
  const { user } = useAuth();
  ...
  return (
    <>
      ...
      <Modal isOpen={isEditModalOpen} onClose={() => setIsEditModalOpen(false)}>
        ...
        <ProgramForm formData={formData} onChange={handleFieldChange} editMode states={programStates} fieldErrors={fieldErrors} />
        <Modal.Footer>
      ...
      <Modal isOpen={isDeleteBlockedOpen} onClose={() => setIsDeleteBlockedOpen(false)}>
        ...
        <Modal.Body>
          <div className="text-center">
            ...
            <h3 className="text-lg font-semibold text-gray-800 dark:text-white">
              Programa vinculado a Notas de Débito
            </h3>
            <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">
              {deleteBlockedMessage}
            </p>
