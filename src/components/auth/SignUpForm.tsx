...
export default function SignUpForm() {
  ...
  return (
    <div className="w-full">
        ...
        {/* Separador "O" */}
        <div className="relative mb-8 py-3 sm:py-5">
          <div className="absolute inset-0 flex items-center">
            <div className="w-full border-t border-gray-200 dark:border-gray-800"></div>
          </div>
          <div className="relative flex justify-center text-sm">
            <span className="px-3 text-gray-400 bg-white dark:bg-gray-900 sm:px-5">
              O
            </span>
          </div>
        </div>
        ...
        <form>
          <div className="space-y-5">
            ...
            {/* */}
            <div>
              <button className="flex items-center justify-center w-full px-4 py-3 text-sm font-medium text-white transition rounded-lg bg-blue-600 shadow-theme-xs hover:bg-blue-700">
                Registrarse
              </button>
            </div>
          </div>
